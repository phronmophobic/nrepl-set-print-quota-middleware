...
Invoke a library API function from the command-line:
    ...
    $ clojure -X com.phronemophobic.nrepl-set-print-quota-middleware/foo :a 1 :b '"two"'
...
Your library will be deployed to com.phronemophobic/nrepl-set-print-quota-middleware on clojars.org by default.
